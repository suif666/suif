...
local LastNormalSize = Vector2.new(560, 400)
...
local function CreateDisplayRow(line, index)
    ...
    local actionsWidth = actionW * 3 + 8 + rightPad + 6
...
print("[UI文本提取器 v22] 已加载 | 已修复显示bug | 简化版")