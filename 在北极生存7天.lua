...
-- 第三方UI.lua
    ...
    ["Load script"] = "加载脚本",
    ["This script is free, but next popup will ask you a key which is just obtainable by joining the discord server"] = "此脚本是免费的，但下一个弹窗会要求你输入密钥，该密钥只需加入 Discord 服务器即可获取[注:需要进discord获取luar链接 然后去解卡]",
    ["type the discord key..."] = "输入 Discord 密钥...",
    ["I know, you don't like Key system but this one is easy\nYou just have to join the Discord\nThen go in the #key channel\nI PROMISE and I'm sorry"] = "我知道，你不喜欢密钥系统，但这个很简单\n你只需加入 Discord\n然后前往 #key 频道\n我保证，对不起",
    ["way.out - The Arctic"] = "way.out - 北极[suif汉化]",
    ["Automation"] = "自动化",
    ["Gathering"] = "采集类",
    ["Auto Dig Snow Fast"] = "自动挖雪",
    ["Dig Interval"] = "挖掘间隔",
    ["Auto Cut Down Trees"] = "自动砍树",
    ["Tree Interval"] = "砍树间隔",
    ["Auto Bring Wood Instantly"] = "自动运送木材",
    ["Wood Interval"] = "运送木材间隔",
    ["Survival"] = "生存类",
    ["Auto Start Fire"] = "自动生火",
    ["Fire Interval"] = "生火间隔",
    ["Auto Cook"] = "自动烹饪",
    ["Cook Interval"] = "烹饪间隔",
    ["Auto Fish"] = "自动钓鱼",
    ["Fish Interval"] = "钓鱼间隔",
    ["Max Fish Wait"] = "最大等待鱼时间",
    ["Show Live Place Info"] = "显示实时地点信息",
    ["UI Hidden"] = "界面已隐藏",
    ["Tap the floating button to re-open the menu."] = "点击浮动按钮重新打开菜单",
}
...
-- 外部脚本链接↓↓↓
-- 外部脚本链接↓↓↓
local ScriptUrl = "https://raw.githubusercontent.com/raphaelmaboi/wayout/refs/heads/main/loader.lua"
